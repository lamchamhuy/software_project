        ...
        <div class="col-12">
            ...
            <div class="row">
                            ...
                            <div class="timeline">
                                @php
                                    $statuses = [
                                        ...
                                        'delivery_failed' => ['label' => 'Giao khong thanh cong', 'icon' => 'triangle-exclamation', 'color' => 'warning'],
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Phan cong nguoi giao hang</h5>
                        </div>
                        <div class="card-body">
                            @if($order->shipper)
                                <div class="alert alert-info py-2">
                                    <div class="fw-semibold">{{ $order->shipper->name }}</div>
                                    <small>{{ $order->shipper->phone ?? $order->shipper->email }}</small>
                                </div>
                            @endif

                            @if(!in_array($order->status, ['delivered', 'completed', 'cancelled']))
                                <form method="POST" action="{{ route('admin.orders.assign-shipper', $order->id ?? $order->order_id) }}">
                                    @csrf
                                    @method('PATCH')
                                    <div class="mb-3">
                                        <label class="form-label">Nguoi giao hang</label>
                                    ...
                                    <button class="btn btn-primary w-100" type="submit">
                                        <i class="fas fa-user-check me-1"></i>Luu phan cong
                                    </button>
                                </form>
                            @else
                                <p class="text-muted mb-0">Don hang da ket thuc nen khong the doi nguoi giao.</p>
                            @endif
                        </div>
                    </div>
