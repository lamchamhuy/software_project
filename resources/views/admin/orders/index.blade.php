                    ...
                    <div class="card-tools">
                        <form method="GET" action="{{ route('admin.orders.index') }}" class="d-flex gap-2">
                            <select name="status" class="form-select form-select-sm">
                                ...
                                <option value="delivery_failed" {{ request('status') == 'delivery_failed' ? 'selected' : '' }}>Giao khong thanh cong</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($order->shipper)
                                                ...
                                                <small class="text-muted">{{ $order->shipper->phone ?? $order->shipper->email }}</small>
                                            @else
                                                <span class="badge bg-secondary">Chua phan cong</span>
                                            @endif
                                        </td>
                                        <td>
                ...
                <div class="row">
                    @php
                        $statusStats = [
                            ...
                            'delivery_failed' => ['label' => 'Giao khong thanh cong', 'color' => 'warning', 'icon' => 'triangle-exclamation'],
